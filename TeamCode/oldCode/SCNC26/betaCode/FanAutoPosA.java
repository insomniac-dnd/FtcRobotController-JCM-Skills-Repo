...
@Autonomous(name = "FanAutoPos", group = "Autonomous")
public class FanAutoPosA extends LinearOpMode {
...
//            sleep(40000);
            ...
            openClaws();
            sleep(1000);
            encoderDrive(DRIVE_SPEED, 22, 22, 180); //S3
            encoderDrive(TURN_SPEED, -24, 24, -90); //T2
            breakmotor(1000);
            verticalServoDown(5.5);
            closeClaws();
            verticalServoUp(0.5);
    ...
    private void breakmotor(double sleepTime){
