...
@Autonomous(name = "imuTorqueNado", group = "Autonomous")
public class DirectAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            encoderDrive(DRIVE_SPEED, 100, 100, 0);
            encoderDrive(TURN_SPEED, 30, -30, -90);
            encoderDrive(DRIVE_SPEED, 100, 100, -90);
            encoderDrive(TURN_SPEED, 30, -30, -180);
            encoderDrive(DRIVE_SPEED, 55, 55, -180);
