...
@Autonomous(name = "PickUpAuto", group = "Autonomous")
public class PickUpAuto extends LinearOpMode {
    ...
    private static final double LEFT_CLAW_CLOSE = 1.0;
    private static final double RIGHT_CLAW_CLOSE = 1.0;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            openClaws();
            encoderDrive(DRIVE_SPEED, 100, 100, 0); //S1
            encoderDrive(TURN_SPEED, -26.5, 26.5, -90); //T1
            breakmotor();
            encoderDrive(DRIVE_SPEED, -15, -15, 90); //S1
            breakmotor();
            sleep(1000);
            encoderDrive(DRIVE_SPEED, 16, 16, 90); //S1
            breakmotor();
            ...
            verticalServoUp(0.5);
            pivotServo.setPosition(1.0);
            encoderDrive(TURN_SPEED, -60, 60, -90);
            encoderDrive(DRIVE_SPEED, 10. 10, -90);
            encoderDrive(TURN_SPEED);
            encoderDrive(DRIVE_SPEED, 110, 110, -90);
            encoderDrive(TURN_SPEED, 26, -26, 180); //T2
            breakmotor();
            encoderDrive(DRIVE_SPEED, 70, 70, 180); //S3
            encoderDrive(TURN_SPEED, 26, -26, 90); //T3
            breakmotor();
