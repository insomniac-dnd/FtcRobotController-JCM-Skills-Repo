...
public class DirectAuto extends LinearOpMode {
    ...
    private static final double LEFT_CLAW_OPEN = 0.5, LEFT_CLAW_CLOSE = 0.3;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            encoderDrive(DRIVE_SPEED, 93, 93, 0); //S1
            encoderDrive(TURN_SPEED, 24, -24, -90); //T1
            breakmotor();
            encoderDrive(DRIVE_SPEED, 120, 120, -90); //S2
